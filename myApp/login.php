...
session_start();
if(!empty($_SESSION["staffMtsFom"]) && $_SESSION["staffLoggedIn"] === true)
{
...
$userName = $userPass = "";
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sqlog = "SELECT user_nm, user_cat, user_pw, user_auth,s.st_id   FROM users u JOIN staff s ON s.username=u.user_nm WHERE user_nm  = ? AND user_st = 1 AND s.st_cat IN (1,7)  ";
        // echo $sqlog;
        ...
        //    echo "<script> alert('OK');</script>";
            ...
            mysqli_stmt_bind_result($stmtLog, $dbunm, $dbucat, $dbupwd, $dbuauth,$dbsid);
            // echo $dbsid;
            ...
            }elseif ($dbuauth == 'l')
            {
                ...
                $userPass = $_POST['userPass'];
                    ...
                    if (!empty($userName) && !empty($userPass)) {
                        ...
                        $ldapSrv = new ExpLdap("172.18.209.212", "OU=Staff,DC=Kln,DC=ac,DC=lk", "kln.ac.lk");
...
///////////////////////////////////////////////////////////////////
    ...
    //     $recNo = '';
    //     //TEACHERS
    //         echo "<script> alert('Check Staff Table ');</script>";
    //         $sqlog = "SELECT CONCAT(t_nm, '. ', firstname, ' ', surname) AS fnm,  username, st_id   FROM staff WHERE username = ? AND st_cat =1";
    ...
    //        // echo $recNo;
    //         if($recNo == 1) {
    //             $dbfullname = $dbusername = $dbsid = '';
    //             mysqli_stmt_bind_result($stmtLog, $dbfullname, $dbusername, $dbsid );
    //             mysqli_stmt_fetch($stmtLog);
    //             echo "<script> alert('Check LDAP pwd ');</script>";
    //             $_SESSION["staffLoggedIn"] = true;
    //             $_SESSION["staffMtsFom"] = $dbusername;
    //             $_SESSION["cat"] = 6;
    //             $_SESSION["staffID"] = $dbsid;
    //             mysqli_stmt_free_result($stmtLog);
    //             mysqli_stmt_close($stmtLog);
        ...
        <style>
            ...
            .user_card {
              /*  height: 400px;*/
                ...
                margin-top: auto;
                margin-bottom: auto;
                background: #DCEDB9; /*#57ba96;/*#fbeec1;/*f39c12*/
                position: relative;
                display: flex;
