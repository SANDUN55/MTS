                    ...
                    <div class="widget-content p-0">
                        <div class="widget-content-wrapper">
                            ...
                            <div class="widget-content-left ml-3 header-user-info">
                                <div class="widget-heading"><?php //echo $_SESSION["userMtsFom"]. ', cat: '. $_SESSION["cat"]; ?>
                                ...
                                <div style="color: white;"> <?php
                                   ...
                                   // include 'assets/scripts/backend/database.php';
                                    if($usercat == 4 || $usercat == 5){
                                        ...
                                        $sql = "SELECT CONCAT (t_nm, '. ', firstname, ' ', surname ) AS stnm, img, url FROM staff WHERE username = '$user' ";
                                        $result = mysqli_query($conn, $sql) or die(mysqli_error());
                                        if($row = mysqli_fetch_array($result)) {
                                            $img = $row['img'];
                                            echo "<img src=\"https://medicine.kln.ac.lk/images/People/Academic-Staff/$img\" width='50px' align='left'> ";
                                            echo '&nbsp;'. $row['stnm'].'&nbsp;';
                                        }
                                    }else{
                                        echo $user;
