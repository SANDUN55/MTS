...
<div class="container">
    <nav class="" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="active breadcrumb-item" aria-current="page">Define Module</li>
        </ol>
    </nav>
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8">
                        <h2><i class="pe-7s-settings"></i> <b>Module Dates</b></h2>
					</div>
                </div>
            </div>
            <table class="table table-striped table-hover">
                <thead>
                    <tr>
                        ...
                        <th  align="right">COMPLETE MODULE</th>
                    </tr>
                </thead>
				<tbody>
<?php
...
?>
				<tr id="<?php echo $row["b_no"]; ?>">
                    ...
                    <td><?php echo $row["st_dt"]; ?>&nbsp;
                        <a href="#editDateModal" class="edit" data-toggle="modal">
                            <i class="pe-7s-pen icon-gradient bg-night-fade updateDate" data-toggle="tooltip"
                    ...
                    <td align="center"> <a href="#endModuleModal" class="end" data-toggle="modal">
