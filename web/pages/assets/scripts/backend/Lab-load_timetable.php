...
$query = " SELECT CONCAT (class_id, '-', class_topic_id) as class_reserve_id, class_topic, class_start, class_end, class_group, CONCAT(t_nm, '. ', firstname, ' ', surname, ' ') AS stVAL , a_name, lab_nm, class_remark FROM `classschedules`
...
$query .= "SELECT CONCAT (class_id, '-', class_topic_id) as class_reserve_id, class_topic, class_start, class_end, class_group, div_nm, a_name, lab_nm, class_remark FROM `classschedules`
 JOIN classtopics ON class_topic_id = topic_id
