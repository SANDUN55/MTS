...
<div class="container">
    <nav class="" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="active breadcrumb-item" aria-current="page">Import Previous Batch Classes</li>
        </ol>
    </nav>
	<p id="success"></p>
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8">
                        <h2><i class="pe-7s-study"></i> <b>Import Previous Batch Classes</b></h2>
					</div>
...
$mod = $batchhMod[1];
$ttStatus = '';
echo $batch; echo ","; echo $mod;
database_conectivity();
$sql_getClass = "SELECT class_topic, class_group, a_name, CONCAT(class_id, '-', class_topic_id) as tids 
...
?>
				<tr id="<?php echo mysqli_result($result, $i, "tids"); ?>">
					<td><?php echo $i+1; ?></td>
                    <td><?php echo mysqli_result($result, $i, "class_topic"); ?></td>
					<td><?php echo mysqli_result($result, $i, "class_topic"); ?></td>
					<td><?php echo mysqli_result($result, $i, "a_name"); ?></td>
            ...
            <ul class="pagination">
                ...
                if(!empty($total_pages)){
                    for($i=1; $i<=$total_pages; $i++){
                        if($i == 1){
                            ?><li class="pageitem <?php if($show_page == $i) { echo 'active'; } ?>" id="<?php echo $i;?>"><a href="import_batchClass.php?page=<?php echo $i; ?>" data-id="<?php echo $i;?>" class="page-link" >page <?php echo $i;?></a></li>
                            <?php
                        }
                        else{
                            ?>
                            <li class="pageitem <?php if($show_page == $i) { echo 'active'; } ?>" id="<?php echo $i;?>"><a href="import_batchClass.php?page=<?php echo $i; ?>" class="page-link" data-id="<?php echo $i;?>">page <?php echo $i;?></a></li>
                            <?php
                        }
                    }
                }
