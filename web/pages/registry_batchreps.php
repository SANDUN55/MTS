    ...
    <nav class="" aria-label="breadcrumb">
        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8">
                        <h2><i class="pe-7s-users"></i> <b>Batch Representatives Registry</b></h2>
					</div>
            ...
            <table class="table table-striped table-hover">
				...
				<tr id="<?php echo $row["rep_id"]; ?>">
					...
					<td align="left"><?php echo $row["st_no"] ; ?></td>
					...
					<td align="center">
                        <a href="#editRepModal" class="edit" data-toggle="modal">
						 ...
						 <a href="#disableBatchRepModal" class="disableRep" data-idr="<?php echo $row["rep_id"]; ?>" data-toggle="modal"><i class="pe-7s-close-circle  icon-gradient bg-happy-itmeo" data-toggle="tooltip" title="Disable"></i></a>
                        </td>
				</tr>
				<?php
				$i++;
...
<!-- Disable Modal HTML -->
<div id="disableBatchRepModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="disable_rep_form">
                <div class="modal-header">
                    <h4 class="modal-title">Disable Batch Representative</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                </div>
                <div class="modal-body">
                    <input type="hidden" id="id_dr" name="id" class="form-control">
                ...
                <div class="modal-footer">
                    ...
                    <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
                    <button type="button" class="btn btn-danger" id="btn-disable-rep">Disable</button>
                </div>
            </form>
        </div>
    </div>
