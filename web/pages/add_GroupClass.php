                ...
                <div class="row">
                    <div class="col">
                             <div class="main-card mb-3 card">
                                 <div class="card-body" style="height: 100%"><h5 class="card-title">ADD  GROUP CLASS</h5>
<!--form-->
                                                ...
                                                $.ajax({
                                                    ...
                                                    success: function(data){
                                                       // alert(data);
                                                        ...
                                                        // Always show group details section for all activities
                                                        $("#grpdetails").show();
                                                        $("#nonGroupDetails").hide();
                                                        $('#grpdetails #divRepeat').hide();
                                                        $('#activity-no').val(actNo);
                                                    ...
                                                    <div class="row" style = "background-color: #1f6f93;" >
                                                        <input name="activity-no" id="activity-no"  type="hidden">
                                                        <div class="col-sm">
                                                            <label style="color: white;">Group Count</label>
                                                            <input name="group-count" id="group-count"  type="number" min="1" max="8" size="8" class="" required >
                                                            <label></label>
                                                            <button class="btn btn-danger" id = "addMore" >add rows</button>
                                                        </div>
                                                    </div>
                                 </div>
                             </div>
                                              ...
                                              <div id="divRepeat">
                                                    <div class="row" id = "actvity_class" style = "background-color: #feffa6;">
                                                        ...
                                                        <div class="col">
                                                            ...
                                                            <input type="time" id="activityStart" name="activityStTime[]"  class="form-control" min="06:30" max="18:00" required>
                                                            <div class="invalid-feedback">
                                                        ...
                                                        <div class="col">
                                                            ...
                                                            <input type="time" id="activityEndtm" name="activityEnTime[]"  class="form-control" min="06:30" max="18:00" required>
                                                            <div class="invalid-feedback">
                                                                Please provide a valid time.
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col">
                                                            ...
                                                            <?php loadAcademicDepartmentsVal(1)?>
                                                        </div>

                                                        <script>
                                                            $('#activityDate1').on('change', function() {
                                                                //alert('ok');
                                                                var strdt = document.getElementById("activityDate1").value;
                                                                var startTm = document.getElementById("activityStart").value;
                                                                ...
                                                                $.ajax({
                                                                    ...
                                                                    success: function(data){
                                                                        ...
                                                                        for (i = 0; i < len; i++) {
                                                                            ...
                                                                            $('#selectAcademicDepVal option[value="' + staffId +'"]').prop('disabled', true);
                                                                        }
                                                                    }
                                                                });
                                                            });
                                                    ...
                                                    <script>
                                                             $(document).on('click','#addMore',function(e) {
                                                                 ...
                                                                 for (i = 1; i < groupCount; i++) {
                                                                     ...
                                                                     let newActivityClass = $("#actvity_class").clone();
                                                                     newActivityClass.find("input, select").each(function() {
                                                                         let currentId = $(this).attr("id");
                                                                         if (currentId) {
                                                                             let newId = currentId + "_" + i;
                                                                             $(this).attr("id", newId);
                                                                         }
                                                                     });
                                                                     $("#divRepeat").append(newActivityClass);
                                                                     e.preventDefault();
                                                                }
                                                             });
