                    ...
                    <div class="col" >
                        <nav class="" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="active breadcrumb-item" aria-current="page">Add Group Class<?php print_r($_SESSION); ?></li>
                            </ol>
                        </nav>
                    </div>
                </div>
...
$sql_getClass = "SELECT class_topic, DATE(class_start) as dt, class_group, a_name, CONCAT(class_id, '-', class_topic_id) as tids 
