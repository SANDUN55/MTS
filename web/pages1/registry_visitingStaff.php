    ...
    <nav class="" aria-label="breadcrumb">
        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8">
                        <h2><i class="pe-7s-study"></i> <b>Visiting Staff Registry</b></h2>
					</div>
            ...
            <table class="table table-striped table-hover">
				...
				$result = mysqli_query($conn,"SELECT CONCAT(t_nm, ' ', firstname, ' ', surname) as sname, st_em, st_id, firstname, surname FROM staff WHERE st_cat = 4 ;");
                $i=1;
