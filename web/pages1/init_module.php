...
<div class="container">
    <nav class="" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="active breadcrumb-item" aria-current="page">Manage Module Managers</li>
        </ol>
    </nav>
        <div class="card-header">
            <h2><i class="pe-7s-note2"></i> <b> Manage Module managers</b></h2>
...
if($total_results!=''){
 ...
 while($row = mysqli_fetch_array($result)) {
     $editable = 0;
     if(($row["en_dt"]) >= date('Y-m-d') AND $row["ttprogress"] <= 1 ) {
         $editable = 1 ;
     }
     echo $editable;
                                ?>
 ...
 <?php }
 else echo "<h2>Please define Modules to display!</h2>"; ?>
                    </div>
                </div>
<?php }  ?>
            </div>
        ...
        <div class="d-block text-right card-footer">
            ...
            <a href="#addModuleModal" class="btn btn-success" data-toggle="modal"><i class="pe-7s-plus"></i> Define New Module</a>
        </div>
</div>
			</div>		
                    </div>
			...
			<div class="modal-content">
				<form id="user_form">
					...
					<div class="modal-footer">
                        ...
                        <button type="reset" class="btn btn-default" id="btn-add">Reset</button>
