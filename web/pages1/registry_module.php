	...
	<p id="success"></p>
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8">
                        <h2><i class="pe-7s-study"></i> <b>Module Registry</b></h2>
					</div>
...
$result = mysqli_query($conn,"SELECT m.*, s.sn_abr, s.sn_nm, s.sn_id FROM module as m JOIN strand as s ON m.m_strand=s.sn_id ORDER BY m.m_phase, m.m_code ASC;");
$i=1;
$rows_per_page=10;
            ...
            <ul class="pagination">
                ...
                if(!empty($total_pages)){
                    for($i=1; $i<=$total_pages; $i++){
                        if($i == 1){
                            ?><li class="pageitem <?php if($show_page == $i) { echo 'active'; } ?>" id="<?php echo $i;?>"><a href="registry_module.php?page=<?php echo $i; ?>" data-id="<?php echo $i;?>" class="page-link" ><?php echo $i;?> ></a></li>
                            <?php
                        }
                        else{
                            ?>
                            <li class="pageitem <?php if($show_page == $i) { echo 'active'; } ?>" id="<?php echo $i;?>"><a href="registry_module.php?page=<?php echo $i; ?>" class="page-link" data-id="<?php echo $i;?>"><?php echo $i;?> ></a></li>
                            <?php
                        }
                    }
                }
